...
$(function() {
	...
	$('.text-toggle-button button').on('click', function () {
       $(this).closest('.text-toggle').toggleClass('open');
    });
	...
	$(window).on('scroll', function () {
       $('.header-search').removeClass('open');
        ...
        var filterRow = $('.filter-big-item');
        var filterRowWidth = filterRow.outerWidth();
        var filterRows = filterRow.length;
        $('.filter-big-list').css('width', filterRowWidth*filterRows);

        if (window.matchMedia('(max-width: 991px)').matches) {

            if(num === 0){
                $('.header-region').appendTo('.header-mob-in');
                $('.header-menu').appendTo('.header-mob-in');
                $('.header-tel').appendTo('.header-mob-in');
                $('.header-log').appendTo('.header-mob-in');
                $('.header').addClass('visible');

                $('.offers-list').removeClass('row').addClass('owl-carousel').owlCarousel({
                    items: 1,
                    margin: 20,
                    dots: false
                });
            ...
            $('.filter-big-list').removeClass('flex');

            if(num3 === 0){
                $('.filter-small-scroll, .filter-big-scroll').mCustomScrollbar('destroy');
                num3 = 1;
            }

            $('.filter-small-items .filter-small').prependTo('.filter-big-list');
            $('.filter-big-item, .filter-small').addClass('filter-mob-item');
            $('.filter-big-item-title, .filter-small-title').addClass('filter-mob-item-title');
            $('.filter-big-item-list, .filter-small-cont').addClass('filter-mob-item-cont');

            $('.products-cart .product-qty').each(function () {
                $(this).appendTo(($(this).closest('.product-table-col').siblings('.product-table-info')));
            });

            $('.product-date, .product-qty-text').each(function () {
                $(this).appendTo(($(this).closest('.product-table-col').siblings('.product-table-info')));
            });

            $('.products-checkout-side .product-table, .products-checkout-side .products-checkout-side-total, .products-checkout-side .products-checkout-edit').insertBefore('.products-checkout-info');

        } else {
            if(num === 1){
                $('.header-region').appendTo('.header-top-in');
                $('.header-log').appendTo('.header-top-in');
                $('.header-tel').prependTo('.header-center-in');
                $('.header-menu').appendTo('.header-bottom-in');
                $('.header').removeClass('visible');

                $('.offers-list').removeClass('owl-carousel').addClass('row').owlCarousel('destroy');

                num = 0;
            }

            $('.filter-big-list').addClass('flex');

            if(num3 === 1){
                $('.filter-small-scroll').mCustomScrollbar({
                ...
                $('.filter-big-scroll').mCustomScrollbar({
                    axis:"x",
                    autoDraggerLength: true,
                    scrollInertia: 200,
                    mouseWheel:{
            ...
            $('.filter-big-list .filter-small').prependTo('.filter-small-items');
            $('.filter-big-item, .filter-small').removeClass('filter-mob-item');
            $('.filter-big-item-title, .filter-small-title').removeClass('filter-mob-item-title');
            $('.filter-big-item-list, .filter-small-cont').removeClass('filter-mob-item-cont');

            $('.products-cart .product-qty').each(function () {
                $(this).appendTo(($(this).closest('.product-table-col').siblings('.product-table-qty')));
            });

            $('.product-date').each(function () {
                $(this).appendTo(($(this).closest('.product-table-col').siblings('.product-table-date')));
            });

            $('.product-qty-text').each(function () {
                $(this).appendTo(($(this).closest('.product-table-col').siblings('.product-table-qty')));
            });

            $('.products-checkout-form .product-table, .products-checkout-form .products-checkout-side-total, .products-checkout-form .products-checkout-edit').appendTo('.products-checkout-side');
        }
        if (window.matchMedia('(max-width: 575px)').matches) {

            if(num2 === 0){
                $('.footer-col-3 .footer-menu').appendTo('.footer-col-4 .footer-block');
                num2 = 1;
            }
            ...
            if(num2 === 1){
                $('.footer-col-4 .footer-menu:last-child').appendTo('.footer-col-3 .footer-block');
                num2 = 0;
            }
        }
    }).trigger('resize');

    $('.drop-cont-in').mCustomScrollbar({
        autoDraggerLength: true,
        scrollInertia: 200,
        mouseWheel:{
    ...
    $('.footer-title').on('click', function () {
       $(this).toggleClass('open').next('.footer-block').slideToggle('fast');
    });

    $('.header-menu > ul > li > a').on('click', function () {
       $(this).parent().toggleClass('active').siblings().removeClass('active').find('.header-menu-in').slideUp('fast');
       $(this).siblings('.header-menu-in').slideToggle('fast');
    });

    $('.accordion-item-title').on('click', function () {
       $(this).siblings('.accordion-item-cont').slideToggle('fast').parent().toggleClass('open').siblings().removeClass('open').find('.accordion-item-cont').slideUp('fast');
    });
    ...
    $('button.product-color-item, button.product-size-item').on('click', function () {
       $(this).addClass('active').siblings().removeClass('active');
    });

    $('.product-qty button').on('click', function () {
       var qtyVal = parseInt($(this).siblings('.product-qty-val').text());
       if($(this).hasClass('product-qty-minus')){
           if(qtyVal > 1){
               $(this).siblings('.product-qty-val').text(qtyVal-1);
           }
       }else{
           $(this).siblings('.product-qty-val').text(qtyVal+1);
       }
    ...
    $('.filter-small-title').append('<b class="filter-overlay"></b>');

    $('.filter-overlay').on('click', function () {
       $(this).closest('.filter-small').toggleClass('open').siblings().removeClass('open');
    });

    $('.filter-overlay, .filter-big-close, .filter-close').on('click', function () {
    ...
    $('.filter-button').on('click', function () {
       $('.filter-big').toggleClass('open');
        $('body').toggleClass('with-filter-open');
       $('.filter-small').removeClass('open');
    });

    $('.filter-big-item-title, .filter-small-title').on('click', function () {
       $(this).closest('.filter-mob-item').toggleClass('filter-mob-item-active').siblings().removeClass('filter-mob-item-active').find('.filter-mob-item-cont').slideUp('fast');
       $(this).siblings('.filter-mob-item-cont').slideToggle('fast');
    });

    $('.profile-tabs-nav-item').on('click', function () {
        var tabIndex = $(this).index() + 1;
        $(this).addClass('active').siblings().removeClass('active');
        $(this).closest('.profile-tabs').find('.profile-tabs-cont-item:nth-child('+tabIndex+')').addClass('active').siblings().removeClass('active');
    });

    $('.profile-pass-change-button').on('click', function () {
        $(this).closest('.form-block-pass').addClass('active');
    });
